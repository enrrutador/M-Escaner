document.addEventListener('DOMContentLoaded', function() {
    ...
    const logoutButton = document.getElementById('logout-button'); // Asegúrate de tener este botón en tu HTML
    ...
    // El resto de las funciones de la aplicación siguen aquí...
});
